...
Если включена авторизация веб-интерфейса, сначала выполните `POST /auth/login` для получения токена, затем нажмите кнопку **Authorize** и введите `Bearer {ваш_токен}`.
:::

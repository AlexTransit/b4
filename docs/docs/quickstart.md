...
Сет — это набор настроек обхода, привязанный к списку доменов или ip адресов. Подробнее о сетах — в разделе [Веб-интерфейс](./ui).
...
- Посмотреть раздел [Веб-интерфейс](./ui) для подробного описания всех возможностей
